...
deposit1 = Deposit.create!(user_id: user1.id, amount: 40000)
40.times {
...
deposit2 = Deposit.create!(user_id: user2.id, amount: 30000)
30.times {
...
deposit3 = Deposit.create!(user_id: user3.id, amount: 30000)
30.times {
