...
user1 = User.create!(username: "seth", email: "seth@gmail.com", is_admin: true, password: 'password')
...
user2 = User.create!(username: "alex", email: "alex@gmail.com", is_admin: false, password: 'password')
...
user3 = User.create!(username: "stan", email: "stan@gmail.com", is_admin: false, password: 'password')
...
user4 = User.create!(username: "steve", email: "steve@gmail.com", is_admin: false, password: 'password')
